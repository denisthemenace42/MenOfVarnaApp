...
namespace MOV.Data.Migrations
{
    ...
    [Migration("20241217153206_InitialDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MOV.Data.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MOV.Data.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MOV.Data.Models.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MOV.Data.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MOV.Data.Models.OrderProduct", b =>
                {
            ...
            modelBuilder.Entity("MOV.Data.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MOV.Data.Models.UserEvent", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("MOV.Data.Models.Comment", b =>
                {
                    b.HasOne("MOV.Data.Models.Event", "Event")
                        .WithMany("Comments")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MOV.Data.Models.Product", "Product")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("MOV.Data.Models.OrderProduct", b =>
                {
                    b.HasOne("MOV.Data.Models.Order", "Order")
            ...
            modelBuilder.Entity("OrderProduct", b =>
                {
                    b.HasOne("MOV.Data.Models.Order", null)
                        .WithMany()
                        .HasForeignKey("OrdersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MOV.Data.Models.Product", null)
                        .WithMany()
